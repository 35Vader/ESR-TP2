...
public class Multicast_exemplo {
    private static void MakeBootstraper(Bootstraper bootstraper){
        ...
        vizinhos_dois_udp.put("7.7.7.7",7770); // cliente professorLima
        vizinhos_dois_udp.put("8.8.8.8",8880); // cliente professorFlavio
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        Cliente professorFlavio = new Cliente("8.8.8.8",2222,"2.2.2.2",8880,8888);
